...
public final class ReaderActivity extends Activity {
    ...
    private void save(){if(book==null||source==null)return;book.page=index;book.mode=mode;if(pageView!=null){book.zoom=persistZoom?pageView.zoom:1;book.offsetX=persistZoom?pageView.normalizedX():0;book.offsetY=persistZoom?pageView.normalizedY():0;}book.updated=System.currentTimeMillis()/1000.0;store.save(book);}
