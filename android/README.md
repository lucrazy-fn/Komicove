...
Aplicativo Android em Java, separado da interface Tkinter do Windows. Android 8.0 ou superior (API 26). Versão 1.3.0, com leitor completo e integração com a API do PANEL.
