...
def find_7zip():
    candidates = [os.environ.get("KOMICOVE_7ZIP_PATH"), os.environ.get("PANEL_7ZIP_PATH"),
...
class ArchiveBackend:
    ...
    def _detect(self):
        ...
        if suffix == '.epub':
            ...
            raise ValueError(ui("Instale o 7-Zip ou configure KOMICOVE_7ZIP_PATH com o caminho do 7z.exe.", "Install 7-Zip or set KOMICOVE_7ZIP_PATH to the 7z executable."))
