...
def _database_url() -> str:
    ...
    return setting("KOMICOVE_DATABASE_URL", "sqlite:///./" + local_name)
...
def init_db() -> None:
    ...
    from komicove_backend.accounts import models as _accounts_models  # noqa: F401
    from komicove_backend.catalog import models as _catalog_models    # noqa: F401
    from komicove_backend.moderation import db_models as _moderation_models  # noqa: F401
